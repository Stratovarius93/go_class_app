      ...
      child: AnimatedTheme(
        ...
        child: Stack(children: [
          (Theme.of(context).scaffoldBackgroundColor ==
              ...
              : Container(),
          Scaffold(backgroundColor: Colors.transparent, body: _Page2()),
        ]),
      ),
    );
  }
                ...
                InkWell(
                    ...
                    onTap: () async {
                      if (_formKey.currentState!.validate()) {
                        BlocProvider.of<NameBloc>(context).add(AddName(_name));
                        Navigator.pushReplacementNamed(context, 'homePage3');
                      }
                    },
                    child: Container(
